...
<header>
  ...
  <nav id="topnav" class="f_r">
    <ul>
      <a href="index.html" target="_blank">首页</a> <a href="http://www.yangqq.com/about.html" target="_blank">关于我</a> <a href="http://www.yangqq.com/news/" target="_blank">文章</a> <a href="http://www.yangqq.com/newstalk/" target="_blank">心情</a> <a href="http://www.yangqq.com/download/" target="_blank">相册</a> <a href="http://www.yangqq.com/jstt/" target="_blank">留言</a>
    </ul>
    ...
    <div class="cloud">
      ...
      <ul>
         ...
         <#list markList as mark>
               <li><a href="/" id="${mark.id}">${mark.name}</a></li>
         </#list>
