...
<div class="iframe-cot pull-right">
    ...
    <div class="form-top">
        <div class="pull-left">
            <button class="btn btn-default" onclick="addResource()"><i class="fa fa-plus mr5"></i>新增</button>
            <button class="btn btn-default" onclick="updateResource()"><i class="fa fa-pencil mr5"></i>编辑</button>
            <button class="btn btn-default" onclick="deleteResource();" ><i class="fa fa-times mr5"></i>删除</button>
        </div>
...
<script type="text/javascript" src="/js/resource/resource_manager.js">
</script>
</div>
</body>
</html>