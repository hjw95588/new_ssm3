 ...
 * Download: http://www.198zone.com ´úÂë±Ê¼Ç
	...
	$.fn.lc_switch = function(on_text, off_text) {
		...
		return this.each(function(){
			...
			if( !$(this).parent().hasClass('lcs_wrap') ) {
				...
				// default texts
				var ckd_on_txt = (typeof(on_text) == 'undefined') ? '已' : on_text;
				var ckd_off_txt = (typeof(off_text) == 'undefined') ? '未' : off_text;
			   ...
			   // labels structure
				...
				var active 		= ($(this).is(':checked')) ? false : true;
				...
				if( $(this).is(':input') && ($(this).attr('type') == 'checkbox' || $(this).attr('type') == '') ) {
