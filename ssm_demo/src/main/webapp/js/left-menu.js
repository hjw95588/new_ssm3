...
function initMenu(){
    if( $(".nav-list0>li:first-child").children("ul").length!=0){
        $(".nav-list0>li:first-child").children("ul").show();
		$(".nav-list1:first>li:first-child a").click();
        $(".nav-list0>li:first-child").children("i").removeClass("fa-angle-left").addClass("fa-angle-down");
    }else {
        $(".nav-list0>li:first-child a:first-child").click();
    }
}