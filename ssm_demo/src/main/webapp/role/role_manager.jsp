...
<div class="iframe-cot pull-right">
    ...
    <div class="form-top">
        <div class="pull-left">
            <button class="btn btn-default" onclick="addRole()"><i class="fa fa-plus mr5"></i>新增</button>
            <button class="btn btn-default" onclick="updateRole()"><i class="fa fa-pencil mr5"></i>编辑</button>
            <button class="btn btn-default" onclick="deleteRole();" ><i class="fa fa-times mr5"></i>删除</button>
        </div>
...
<script type="text/javascript" src="/js/role/role_manager.js">
</script>
</div>
</body>
</html>