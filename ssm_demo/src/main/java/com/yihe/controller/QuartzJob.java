...
public class QuartzJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	//String name=JSON.toJSONString(detail.getJobDataMap().get("name"));
    	try {
    		freeMarkerConfigurer=(FreeMarkerConfigurer) context.getScheduler().getContext().get("freeMarkerConfigurer");
    		publishService=(IPublishService) context.getScheduler().getContext().get("publishService");
    		markService=(IMarkService) context.getScheduler().getContext().get("markService");
	...
	public void initDemo() {
		...
		System.out.println("开始进行操作时间-----------"+da);
